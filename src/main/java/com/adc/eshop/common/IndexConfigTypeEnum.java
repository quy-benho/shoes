...
public enum IndexConfigTypeEnum {
    ...
    DEFAULT(0, "DEFAULT"),
    INDEX_SEARCH_HOTS(1, "INDEX SEARCH HOTS"),
    INDEX_SEARCH_DOWN_HOTS(2, "INDEX SEARCH DOWN HOTS"),
    INDEX_GOODS_HOT(3, "INDEX GOODS HOTS"),
    INDEX_GOODS_NEW(4, "INDEX GOODS NEW"),
    INDEX_GOODS_RECOMMOND(5, "INDEX GOODS RECOMMOND");
